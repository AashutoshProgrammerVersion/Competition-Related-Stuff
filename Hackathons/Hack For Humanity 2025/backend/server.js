...
// Loads a tool that helps make requests to other websites (like APIs)

const User = require('./models/User'); 
// Imports our User template that defines how user data should be stored

const mongoose = require('mongoose'); 
// Loads a tool that helps us work with MongoDB database
